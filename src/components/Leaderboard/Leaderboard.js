...
const Leaderboard = () => {
    ...
    return  (
        <div className="w-screen md:w-10/12 p-4 overflow-x:auto dev-border">
            <div className="flex flex-wrap space-y-4 sm:space-y-0 items-center justify-between p-4 dev-border">
